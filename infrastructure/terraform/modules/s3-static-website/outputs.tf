...
output "route_53_record_website_name" {
  ...
  value       = try(aws_route53_record.website_cloudfront_record[0].name, null)
}

output "route_53_record_website_fqdn" {
  description = "FQDN built using the zone domain and name."
  value       = try(aws_route53_record.website_cloudfront_record[0].fqdn, null)
}

output "route_53_record_www_website_name" {
  description = "The name of the record."
  value       = try(aws_route53_record.www_website_record[0].name, null)
}

output "route_53_record_www_website_fqdn" {
  description = "FQDN built using the zone domain and name."
  value       = try(aws_route53_record.www_website_record[0].fqdn, null)
}
