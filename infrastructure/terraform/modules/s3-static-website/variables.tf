...
variable "website_origin_path" {
  description = "(Optional, Default:\"\") A bucket path to consider when deploying the static files. Default to \"\"."
  type        = string
  default     = ""
}
...
variable "website_cors_allow_all_origins" {
  description = "(Optional) Specifies if all origins should be allowed in CORS configuration. If true, var.website_cors_additional_allowed_origins is ignored. Defaults to false"
  type        = bool
  default     = false
}
...
variable "cloudfront_response_header_policy" {
  description = "(Optional) - Origin Header policy."
  type = object({
...
variable "create_route53_hosted_zone" {
  description = "Enable or disable Route 53 hosted zone creation. If set to false, the variable route53_hosted_zone_id is required. Defaults to false"
  type        = bool
  default     = false
}
...
variable "create_website_cloudfront_record" {
  description = "Enable or disable Route 53 website record zone creation. Defaults to false"
  type        = bool
  default     = false
}
