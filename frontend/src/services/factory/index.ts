...
const getGeneralInfo = async (): Promise<AxiosResponse<IGeneralInfo>> => {
  //return http.get(`/api/v1/wallets/general-info`)
  return {
    data: mockGeneral,
    status: 200,
    statusText: '',
...
const getBurnInfo = async (): Promise<AxiosResponse<IBurnInfo>> => {
  //return http.get(`/api/v1/wallets/burn-info`)
  return {
    data: mockBurn,
    status: 200,
    statusText: '',
